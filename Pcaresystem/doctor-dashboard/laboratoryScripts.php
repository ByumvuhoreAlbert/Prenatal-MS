...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($checkStmt->num_rows > 0) {
        $stmt = $conn->prepare("INSERT INTO laboratoryExams (Test_Date, patientID, contact,testDate, WBC, RBC, Hb, Plt, RPR_NP, HIV_NP, Malaria_NP, Hepatite_B_NP, Hepatite_C_NP, Glycemia, AdditionalComments) VALUES (NOW(),?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
